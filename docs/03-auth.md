...
**Product:** Esports Hub
**Protected Routes:** /dashboard, /account, /ideas, /cryptos, /stadiums
**Onboarding:** 3 steps
...
**Steps:**
1. Create an Account: Provide email, password, and other required information
2. Verify Email Address: Click the verification link sent to your email address
3. Set up Profile: Provide additional information, such as name and profile picture
