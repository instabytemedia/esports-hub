...
**Product:** Esports Hub
**Design Style:** Neon Arena
**Mode:** dark
**Border Radius:** 0.5
**Primary Color:** #6366f1
**Design Description:** The design should evoke the excitement of a packed stadium, with neon lights and bold graphics. The atmosphere should be lively and dynamic, with a focus on community engagement and competition. The visual elements should include futuristic and high-tech details, such as circuit boards and fiber optics, to reflect the blockchain and AR aspects of the app. The overall picture should be one of fast-paced action and thrilling entertainment.
