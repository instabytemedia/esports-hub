...
**Description:** A blockchain-based social network that enables the trading of digital collectibles, participation in prediction markets, and engagement in AR-powered fantasy sports leagues
...
- **title:** Object with default and template
  - default: "Esports Hub"
  - template: "%s | Esports Hub" (for page-specific titles)
...
- "/" → "Esports Hub"
- "/login" → "Sign In | Esports Hub"
- "/signup" → "Sign Up | Esports Hub"
- "/dashboard" → "Dashboard | Esports Hub"
